...
const {
  ...
  getUserIdHandler,
  createUserHandler,
} = require("../handlers/usersHandler"); //Acá estamos requiriendo a los manejadores (handlers) para usarlos luego cuando queremos hacer algo cuando se matchee con el path detallado.
